...
################## We use miniimagenet in this repository #####################
...
######### For training and validation data splitting. 64 meta-train class, 16 meta-valid class, 20 meta-test class. ##############
